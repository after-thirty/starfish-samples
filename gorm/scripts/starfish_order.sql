...
*/
CREATE
database if NOT EXISTS `starfish_order` default character set utf8mb4 collate utf8mb4_unicode_ci;
use
`starfish_order`;
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='undo_log';
