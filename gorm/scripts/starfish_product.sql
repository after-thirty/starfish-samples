/*
 ...
 Source Schema         : starfish_product
...
CREATE
database if NOT EXISTS `starfish_product` default character set utf8mb4 collate utf8mb4_unicode_ci;
use
`starfish_product`;
...
BEGIN;
INSERT INTO `product`
VALUES (1, '刺力王', '从小喝到大的刺力王', '好喝好喝好好喝', '',
        'https://img10.360buyimg.com/mobilecms/s500x500_jfs/t1/61921/34/1166/131384/5cf60a94E411eee07/1ee010f4142236c3.jpg',
